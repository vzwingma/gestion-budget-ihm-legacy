...
import com.terrier.finances.gestion.ui.budget.listeners.ActionsLigneDepenseClickListener;
 ...
 *
 */
public class ActionsLigneOperation extends AbstractUIComponent<ActionsLigneOperationController> {
	 ...
	 * visual editor.
	 */
	public ActionsLigneOperation(LigneOperation operation) {
		buildMainLayout();
		...
		getControleur().setIdOperation(operation.getId());
	}
	 ...
	 */
	@Override
	public ActionsLigneOperationController createControleur() {
		return new ActionsLigneOperationController(this);
	}	
