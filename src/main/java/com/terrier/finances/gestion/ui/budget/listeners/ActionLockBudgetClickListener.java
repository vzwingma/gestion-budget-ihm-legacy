 ...
 *
 */
public class ActionLockBudgetClickListener extends AbstractActionUtilisateurListener implements ClickListener {
	...
	public void boutonClick(ClickEvent event) {
		...
		boolean budgetActif = getUserSession().getBudgetMensuelCourant().isActif();
