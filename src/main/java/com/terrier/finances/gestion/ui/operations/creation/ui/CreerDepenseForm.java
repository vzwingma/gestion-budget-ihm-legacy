...
public class CreerDepenseForm extends AbstractUIComponent<CreerDepenseController> implements NewItemProvider<String> {
	...
	@AutoGenerated
	private ComboBox<CategorieOperation> comboBoxSsCategorie;

	@AutoGenerated
	private ComboBox<CategorieOperation> comboBoxCategorie;
	 ...
	 */
	public ComboBox<CategorieOperation> getComboBoxSsCategorie() {
	 ...
	 */
	public ComboBox<CategorieOperation> getComboBoxCategorie() {
